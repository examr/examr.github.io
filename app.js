...
const resize = () => {
    if (window.innerWidth > 768) {
      if (
        document
          .getElementById("menuHide")
          .classList.contains("inline-block")
      ) {
        document
          .getElementById("menuHide")
          .classList.remove("inline-block");
        document.getElementById("menuHide").classList.add("hidden");
        document.getElementById("menuShow").classList.add("inline-block");
        document.getElementById("menuShow").classList.remove("hidden");
        document.getElementById("navlinks").classList.remove("flex");
        document.getElementById("navlinks").classList.add("hidden");
        if (document.body.classList.contain("overflow-hidden")) { document.body.classList.remove("overflow-hidden"); }
    }
}
  };
  const menuToggle = () => {
      if (window.innerWidth < 768) {
          document.getElementById("menuHide").classList.toggle("inline-block");
          document.getElementById("menuHide").classList.toggle("hidden");
          document.getElementById("menuShow").classList.toggle("inline-block");
